...
POLARS_VERSION_GE_15 = POLARS_VERSION >= parse("1.5")
POLARS_VERSION_GT_15 = POLARS_VERSION > parse("1.5")
POLARS_VERSION_LT_15 = POLARS_VERSION < parse("1.5")
...
if POLARS_VERSION_LT_15:
    raise ImportError(
        "cudf_polars requires py-polars v1.5 or greater."
    )  # pragma: no cover
